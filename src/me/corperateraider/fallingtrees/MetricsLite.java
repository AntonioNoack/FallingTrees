...
public class MetricsLite{
	/* I want stats, but don't know how so I used them from
	 * PortableTent by vasil7112 - should work
	 * */
	...
	private void postPlugin(boolean isPing) throws IOException {
		...
		Object o;
		try {
			o = Server.class.getMethod("getOnlinePlayers").invoke(server);
			if(o instanceof Collection){
				playersOnline = ((Collection<?>) o).size();
			} else
				playersOnline = ((Player[]) o).length;
		...
		URL url = new URL("http://report.mcstats.org/plugin/"+urlEncode(pluginName));
